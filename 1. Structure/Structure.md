...
    if (lazy[i]) {
        tree[i << 1].sum += (tree[i << 1].r - tree[i << 1].l + 1) * lazy[i];
        tree[i << 1 | 1].sum += (tree[i << 1 | 1].r - tree[i << 1 | 1].l + 1) * lazy[i];
        tree[i << 1].mx += lazy[i];
        tree[i << 1 | 1].mx += lazy[i];
        lazy[i << 1] += lazy[i];
        lazy[i << 1 | 1] += lazy[i];
        lazy[i] = 0;
    }
...
    if (x <= mid) upd(i << 1, x, y, k);
    if (y > mid) upd(i << 1 + 1, x, y, k);
    push_up(i);
}
  
//  Sum
